...
def generatedImage
  ...
  PNGS.each do |png|
    ...
    total_line += "\tpublic static var #{var_name}: NSImage { return pngImage(named: \"#{file_name}\") }\n"
  end
  ...
  PDFS.each do |png|
    ...
    var_name = base_name.to_camel
    file_name = base_name
    total_line += "\tpublic static var #{var_name}: NSImage { return image(named: \"#{file_name}\") }\n"
  end
